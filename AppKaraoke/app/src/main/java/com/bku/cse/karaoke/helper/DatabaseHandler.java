...
public class DatabaseHandler extends SQLiteOpenHelper {
     ...
     * */
    public void addUser(String name, String email, String phone_no, Boolean gender, String birthday, String avatar) {
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("phone_no", cursor.getString(3));
            user.put("gender", cursor.getString(4));
            user.put("birthday", cursor.getString(5));
            user.put("avatar", cursor.getString(6));
        }
        cursor.close();
        db.close();
        // return user
